	...
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Engineers Shopping Cart</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with us.<br>"
					...
					+ "<span class='greenText'>CART500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
