...
<%@ page import="com.project.service.impl.*,com.project.service.*"%>
...
<body style="background-color: "black";">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #000000; color: white; padding: 5px;">
		<h2>Welcome to ENGINEERS SHOPPING CART</h2>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>ENGINEER Shopping Center</a>
			</div>
